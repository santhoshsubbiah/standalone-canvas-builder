...
menu_container.zcanvasMenu(menuOptions);
...
// setTimeout(function () {
//     enablePerfectScroll('canvas_scroll_menu'); // NO I18N
//     enablePerfectScroll('canvas-available-tools'); // NO I18N
// }, 200);
...
//var pickertemp = '<lyte-colorpicker id="zcanvascolorpicker" lt-prop-appearance = "box" lt-prop-wrapper-class="zccolorpickerwrap"></lyte-colorpicker>'; // NO I18N
// eslint-disable-next-line no-body-events
//$('body').append(pickertemp); // NO I18N
...
var showpicker = function (origin, prop, el, callback, ref) {
    //Lyte.registeredMixins['canvas-builder-settings'].colorPersistance(); // NO I18N
    //colorPersistance();
    var colorpickerEle = document.getElementById('zcanvascolorpicker');
    var currentcolor = $(origin).css('background-color'); // NO I18N
    var selectedcolor = getcurrentrgb(currentcolor);
    // colorpickerEle.setData('ltPropCurrentRgbCode', selectedcolor.hex.replace('#', '')); // NO I18N
    // colorpickerEle.setData('ltPropBoardColor', selectedcolor.hex); // NO I18N
    // colorpickerEle.setData('ltPropSelectedColor', selectedcolor); // NO I18N
    // colorpickerEle.setData('opacity', selectedcolor.opacity); // NO I18N

    colorpickerEle.ltProp({
        'originElement': origin, //NO I18N
        'show': true,  //NO I18N
        'advancedColorButton': true, //NO I18N
        'closeOnBodyClick': true, //NO I18N
        'closeOnSelection': true, //NO I18N
        'noFillButton': true // NO I18N

    });


    colorpickerEle.setMethods({
        onSelect: function (e, colorvalue) {
            if (colorvalue.rgb === 'transparent') { // NO I18N
                if (jsonCreation.toolinst && jsonCreation.toolinst.selectedfields.hasClass('zcanvas-editor-outer') && prop === "background-color") {
                    colorvalue.rgba = 'rgba(255,255,255,1)'; // NO I18N
                } else {
                    colorvalue.rgba = 'rgba(255,255,255,0)'; // NO I18N
                }
            }
            var value = { style: {} };
            value.style[prop] = colorvalue.rgba; //No I18N
            $(origin).css('background-color', colorvalue.rgba); //No I18N
            //					if(preprocess){
            //						value = preprocess.bind(ref)(value);
            //					}
            ...
            if (ref && ref.config.sync) {
                var hex = colorvalue.hex ? colorvalue.hex.replace('#', '') : '000000'; // NO I18N
...
var layoutoptions = {
    ...
    nosearch: true,
    groups: {
        'layouts': { data: new zclayout('id', ["Static Icon", "Section Layout", "Tab Layout", "Static Text", , "Line", "Table Layout"]) } // NO I18N
    },
    uniqueId: 'id', //NO I18N
...
var options = {
    ...
    contextmenu: true,
    commonSkipContextMenuItems: ["fixed"],
    disableContextMenu: ["Tab Layout", "Tab Bar", "Tab Container"],
...
options.toolsRef = new zcanvastools({
    ...
    gettype: function (selectedfields) {
        ...
        var isTabContainer = selectedfields.hasClass('zc-tab-content'); // NO I18N
        ...
        if (selectedfields.hasClass('zcanvas-static-editor')) { // NO I18N 
        ...
        } else if (selectedfields.hasClass('tab') || selectedfields.hasClass('tabname')) { // NO I18N
            ...
            selecteddata = { zctype: selectedfields.parent().attr('data-layout-selctabletype') }; // NO i18N
    ...
    tools: {
        ...
        'Static Icon': ['radiusslider', 'radiusinput', 'radiusleftinput', 'radiustopinput', 'radiusrightinput', 'radiusbottominput', 'radiusswitch', 'radiushideswt', // NO I18N
            'shadowhideswt', 'border', 'bordert', 'borderr', 'borderb', 'borderl', 'borderswitch', 'borderhideswt', 'bgcolor', 'iconcolorhex', 'iconcolor', // NO I18N
            'paddingslider', 'paddinginput', 'paddingleftinput', 'paddingtopinput', 'paddingrightinput', 'paddingbottominput', 'paddingswitch', 'paddinghideswt', // NO I18N
            'bgadvanced', 'bgimagecontd', 'bggradcontd', 'bgimagecover', 'bgimagerepeat', 'bgcolorinput', 'depthforward', 'depthbackward', 'visibility'], // NO I18N
    ...
    theme: {
        currenttheme: {
            ...
            button: {
                ...
                "hover": { // NO I18N
                    "color": "rgba(234, 238, 245, 1)", // NO I18N
                    "background-color": "rgba(34, 40, 51, 1)" // NO I18N
                }
            },
            'Tab Layout': { // NO I18N
                "default": { // NO I18N
            ...
            'Tab': {
                "default": { // NO I18N
                    "background-color": "rgb(255,255,255)"// NO I18N
                }
            },
            page: {
                "default": { // NO I18N
...
// var showJqColorpicker = function (which, prop, el, callback, ref, preprocess) {
//     var container = which;
//     // var config = config;
//     // var outerThis = self;
//     $(which).bind("click", function () { //No I18N
//         // var offSet = $(this).offset();
//         // $(".fieldPropPick").css({'left':(offSet.left)+'px','top':(offSet.top+38)+'px'}).show();//No I18N
//         // $(".props").hide();
//         //       $("#font_dropdown").hide();
//     }).ColorPicker({
//         onBeforeShow: function () {
//             $(this).ColorPickerSetColor("white");
//         },
//         onShow: function (colpkr) {
//             $(colpkr).css("z-index", "1501");//No I18N
//             $(colpkr).fadeIn(500);
//             $(".colorpicker_submit").hide();
//             $(".colorpicker_current_color").hide();
//             $(".colorpicker_rgb_r").hide();
//             $(".colorpicker_rgb_g").hide();
//             $(".colorpicker_rgb_b").hide();
//             $(".colorpicker_hsb_h").hide();
//             $(".colorpicker_hsb_s").hide();
//             $(".colorpicker_hsb_b").hide();
//             return false;
//         },
//         onChange: function (hsb, hex, rgb) {
//             $(container).css("background-color", "#" + hex);//No I18N
//             var colorvalue = {};
//             colorvalue.rgba = rgb;
//             if (colorvalue.rgb === 'transparent') { // NO I18N
//                 colorvalue.rgba = 'rgba(255,255,255,0)'; // NO I18N
//             }
//             var value = { style: {} };
//             var colorValue = hexToRGB('#' + hex, 1);
//             value.style[prop] = colorValue; //No I18N
//             $(which).css('background-color', colorvalue.rgba); //No I18N
//             if (preprocess) {
//                 value = preprocess.bind(ref)(value);
//             }
//             if (callback) {
...
//             // $("#formColor").val("#"+hex);
//             // if(how == "bg"){
//             //   $(".basic_edit").css("background-color","#"+hex);
//             // } else {
//             //   $(".basic_edit").css("color","#"+hex);
//             // }
//             //                jSortable.cvDemoCreate();
//             // jSortable.createTableStructure();
//         },
//         onHide: function (colpkr, hex) {
//             $(".bgcolor").removeClass('active');//No I18N
//             $(colpkr).fadeOut(500);
//             $("#fieldPropPick").css("display", "none");//No I18N
//             //                crmView.cvView('','demo');
...
//	       		Lyte.registeredMixins["canvas-builder-settings"].createcontextuals(options.toolsRef); // NO I18N
//	this.createcontextuals(options.toolsRef); // NO I18N
...
var viewtools = new zcanvastools({
    ...
    theme: {
        selector: {
            ...
            button: {
                'default': '#previewcanvas .zccbutton.zcanvas-field',
                'hover': '#previewcanvas .zccbutton.zcanvas-field:hover'
            }, // NO I18N
            'Tab Layout': { // NO I18N
...
outereditor.zcanvas(options);

// Set Default Editor Width for Mobile (500px)
outereditor.width(500);
outereditor.parent().width(500);
